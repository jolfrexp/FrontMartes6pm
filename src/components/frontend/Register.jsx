  ...
  return (
    <div className='Inicio '>
      ...
      <form className='formulario' onSubmit={handleSubmit(onSubmited)}>
        ...
        <input type="text" id='nombre' {...register('nombre',{require:true})} placeholder='Name'required />
        <div className="age">
          <label>Edad</label>
        </div>
        ...
        <div>
        <input type="email" placeholder='Correo@Example.com' {...register('correo',{require:true})} required id='correo'/></div>
        </div>
        <div className="key">
